...
-- UNIVERSAL BOSS FARM SCRIPT
-- Auto-farm for: Rip_indra, Darkbeard, Doughking, Tyrant, Cursed_captain
-- Usage: set getgenv().name to one of the supported boss names before executing this file.

local bossName = (getgenv().name or ''):lower()


--[[ ===== START: RIP_INDRA ===== ]]
if bossName == 'rip_indra' then
    -- Các cài đặt ban đầu
...
--[[ ===== START: FARMTYRANTOFTHESKIES ===== ]]
if bossName == 'farmtyrantoftheskies' then
    -- Các cài đặt ban đầu
    local TrollApi = loadstring(game:HttpGet("https://raw.githubusercontent.com/PorryDepTrai/exploit/main/SimpleTroll.lua"))()
...
--[[ ===== END: FARMTYRANTOFTHESKIES ===== ]]


--[[ ===== START: CURSEDCAPTIANV2 ===== ]]
if bossName == 'cursedcaptianv2' then
    -- Khởi tạo
    local TrollApi = loadstring(game:HttpGet("https://raw.githubusercontent.com/PorryDepTrai/exploit/main/SimpleTroll.lua"))()
